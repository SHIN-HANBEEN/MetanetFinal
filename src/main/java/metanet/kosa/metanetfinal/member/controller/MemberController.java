...
public class MemberController {
	...
	public String mypage(Principal principal, Model model) {
		...
		List<DetailedReservation> ReservationList = reservationService.getReservationHistoryForLastSixMonth(false,
				phoneNum);
		// 전체 예매 내역 수
		...
		// 최근 6개월의 예매 취소 내역 조회
		List<DetailedReservation> cancelReservationList = reservationService.getReservationHistoryForLastSixMonth(true,
				phoneNum);
