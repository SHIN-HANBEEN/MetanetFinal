...
public class CoolSmsController {
    ...
    public SingleMessageSentResponse sendOne(@RequestBody Map<String, String> requestMap) {
    ...
    public SingleMessageSentResponse sendMmsByResourcePath(@RequestBody Map<String, String> requestMap) throws IOException {
