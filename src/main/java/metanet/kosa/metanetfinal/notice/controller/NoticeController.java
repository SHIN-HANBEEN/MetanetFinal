...
public class NoticeController {
	...
	public String getNoticeDetails(@PathVariable int noticeId, @PathVariable(required = false) Integer page,
	...
	public ResponseEntity<Resource> fileDownload(@PathVariable String dirPath) throws IOException {
		// Path fullPath = Paths.get("C:/upload/" +
		// dirPath.substring("/upload/".length()));
...
//		}
	...
	public String updateNotice(@PathVariable int noticeId, Notices notice, BindingResult results, String csrfToken,
			MultipartFile file, HttpSession session, RedirectAttributes redirectAttrs) {
